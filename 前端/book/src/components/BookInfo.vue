...
<header style="height: 140px">
  ...
  <div class="header_head">
    <div class="header_head_box">
      ...
      <ul>
        <li>
          <a @click="LoginManagement">{{this.welcome_title}}</a>
        </li>
        <li>
            ...
            <div class="box-two">
              ...
              <div class="box-add">
                  <form id="itemForm" method="post" style="width: 100%;height: 100px;" >
                    <el-input-number v-model="num" class="selectNum" @change="handleChange" :min="1"></el-input-number>
      ...
      methods:{
        ...
        getLoginState(){
          ...
          if(this.token == ''){//未登录
            ...
            this.$axios.get('http://114.116.226.207:8222/userservice/user/select/'+this.token).then(response => {
        ...
        getData(){
          ...
          this.$axios.get('http://114.116.226.207:8222/bookservice/book/bookinfo/'+this.bookid).then(response=>{
            this.book_info=response.data.data.bookinfo;
          })
          if(this.book_info.marketPrice ==''){
            this.marketprice_show=false
          }
